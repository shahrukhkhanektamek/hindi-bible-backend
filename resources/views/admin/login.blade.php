                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> {{env("APP_NAME")}}. Developed By <i class="mdi mdi-heart text-danger"></i> by <a href="https://www.codediffusion.in/" target="_blank">Code Diffusion</a>
                            </p>
                        </div>
                    </div>
                </div>
