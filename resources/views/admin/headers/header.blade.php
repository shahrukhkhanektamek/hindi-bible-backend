            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{route('intro-video.list')}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{route('news.list')}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{route('thankyou-message.list')}}">
