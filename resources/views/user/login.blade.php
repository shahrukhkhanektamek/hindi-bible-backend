...
<div class="login-box">
  <div class="login-box-body">
      ...
      <div>
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <a href="{{route('user.user-forgot')}}" class="pull-right"><i class="fa fa-lock"></i> Forgot pwd?</a>
          </div>
        </div>
        <!-- /.col -->
    ...
    <div class="m-t-2">Don't have an account? <a href="{{route('user.registration')}}" class="text-center">Sign Up</a></div>
  </div>
  <!-- /.login-box-body --> 
</div>
<!-- /.login-box --> 
