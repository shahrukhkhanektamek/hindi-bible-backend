...
class UserPostController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        if(!empty($request->category_id)) $category_id = $request->category_id;
        if(!empty($request->sub_category_id)) $sub_category_id = $request->sub_category_id;
        if(!empty($request->sub_sub_category_id)) $sub_sub_category_id = $request->sub_sub_category_id;
        if(!empty($request->sub_sub_sub_category_id)) $sub_sub_sub_category_id = $request->sub_sub_sub_category_id;
        ...
        if(!empty($category_id)) $data_list = $data_list->where("category_id", $category_id);
        if(!empty($sub_category_id)) $data_list = $data_list->where("sub_category_id", $sub_category_id);
        if(!empty($sub_sub_category_id)) $data_list = $data_list->where("sub_sub_category_id", $sub_sub_category_id);
        if(!empty($sub_sub_sub_category_id)) $data_list = $data_list->where("sub_sub_sub_category_id", $sub_sub_sub_category_id);
