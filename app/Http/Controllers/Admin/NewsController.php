...
class NewsController extends Controller
{
     protected $arr_values = array(
        ...
        "folder_name"=>'/news',
        "upload_path"=>'upload/',
        "page_name"=>'news-detail.blade.php',
        "keys"=>'id,name',
    ...
    public function load_data(Request $request)
    {
      ...
      $data_list = News::where([$this->arr_values['table_name'].'.status' => $status])->orderBy('id',$order_by);
    ...
    public function update(Request $request)
    {
        ...
        if(empty($id)) $data = new News;
        else $data = News::find($id);
