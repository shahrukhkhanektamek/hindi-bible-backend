...
class ThankyouMessageController extends Controller
{
     protected $arr_values = array(
        'routename'=>'thankyou-message.', 
        'title'=>'Thankyou Message', 
        'table_name'=>'thankyou_message',
        'page_title'=>'Thankyou Message',
        "folder_name"=>'/thankyou-message',
        "upload_path"=>'upload/',
        "page_name"=>'thankyou-message-detail.blade.php',
        "keys"=>'id,name',
    ...
    public function load_data(Request $request)
    {
      ...
      $data_list = ThankyouMessage::where(['status' => $status])->orderBy('id',$order_by);
    ...
    {   
        ...
        $row = ThankyouMessage::where(["id"=>$id,])->first();
        if(!empty($row))
        {
            return view($this->arr_values['folder_name'].'/form',compact('data','row'));
        }
    ...
    public function update(Request $request)
    {
        ...
        if(empty($id)) $data = new ThankyouMessage;
        else $data = ThankyouMessage::find($id);
