...
class SubSubCategoryController extends Controller
{
    ...
    public function load_data(Request $request)
    {
      ...
      if(!empty($request->sub_category)) $sub_category = $request->sub_category;
      ...
      if(!empty($sub_category)) $data_list->where("sub_category_id", $sub_category);
