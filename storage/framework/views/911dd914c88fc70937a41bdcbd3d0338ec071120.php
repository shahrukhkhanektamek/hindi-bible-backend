                    ...
                    <td>
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <?php ($check = DB::table("sub_sub_category")->where("sub_category_id", @$value->id)->first()); ?>
                                <?php if(!empty($check)): ?>
                                    <a href="<?php echo e(route('sub-sub-category.list')); ?>?id=<?php echo e(Crypt::encryptString($value->id)); ?>"><?php echo e($value->name); ?></a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('post.add')); ?>?sub-category-id=<?php echo e(Crypt::encryptString($value->id)); ?>"><?php echo e($value->name); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </td>
...
<?php /**PATH D:\xamp\htdocs\projects\codediffusion\hindibible\resources\views\admin\sub-category\table.blade.php ENDPATH**/ ?>