                    ...
                    <td>
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <a href="<?php echo e(route('post.add')); ?>?sub-sub-sub-category-id=<?php echo e(Crypt::encryptString($value->id)); ?>"><?php echo e($value->name); ?></a>
                            </div>
                        </div>
                    </td>
...
<?php /**PATH D:\xamp\htdocs\projects\codediffusion\hindibible\resources\views\admin\sub-sub-sub-category\table.blade.php ENDPATH**/ ?>