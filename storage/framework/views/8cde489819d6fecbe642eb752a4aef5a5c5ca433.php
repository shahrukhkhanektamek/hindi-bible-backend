                                        ...
                                        <div class="col-md-2">
                                         ...
                                         <div class="col-md-2">
                                            <select class="form-control" data-href="" data-target="#sub-category" id="category" required>
                                                ...
                                                <?php ($category = DB::table("category")->where("id", Crypt::decryptString(request()->id))->first()); ?>
                                                <?php endif; ?>
...
<script>
   ...
   function get_url_data()
   {
       ...
       data = `status=${status}&order_by=${order_by}&limit=${limit}&filter_search_value=${filter_search_value}&category=${category}`;
   }
    get_url_data();
   url = main_url+'?'+data;
   load_table();
   $(document).on("change", "#statuschange, .order_by, .limit, #category",(function(e) {
      get_url_data();
      url =main_url+"?"+data;
      load_table();
   }));
...
</html><?php /**PATH D:\xamp\htdocs\projects\codediffusion\hindibible\resources\views\admin\sub-category\index.blade.php ENDPATH**/ ?>