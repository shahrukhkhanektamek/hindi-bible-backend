        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <!-- end page title -->
                    <form class="mt-2 needs-validation form_data" action="<?php echo e(route('user.change-sponser-revert-income-action')); ?>" method="post" enctype="multipart/form-data" id="form_data_submit" novalidate>
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\xamp\htdocs\projects\codediffusion\hindibible\resources\views\admin\user\change-sponser-revert-income.blade.php ENDPATH**/ ?>