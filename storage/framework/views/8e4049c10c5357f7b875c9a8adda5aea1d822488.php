                                ...
                                <div class="card card-animate">
                                    <div class="card-body">
                                        <a href="<?php echo e(route('user.edit').'/'.Crypt::encryptString($row->id)); ?>">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <p class="text-uppercase fw-medium text-muted text-truncate mb-0"> Plan List</p>
                                                </div>
                                            </div>      
                                        </a>                                  
                                    </div>
...
</html><?php /**PATH D:\xamp\htdocs\projects\codediffusion\hindibible\resources\views\admin\user\account-view.blade.php ENDPATH**/ ?>