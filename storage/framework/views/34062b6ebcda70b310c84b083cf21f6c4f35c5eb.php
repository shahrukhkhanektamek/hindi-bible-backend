            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('intro-video.list')); ?>">
                                <i class="ri-product-hunt-line"></i> <span data-key="t-dashboards">Intro Video</span>
                            </a>
                        </li>
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('category.list')); ?>">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">Menu</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('sub-category.list')); ?>">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">1 Sub Menu</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('sub-sub-category.list')); ?>">
                                            <i class="ri-file-copy-line"></i> <span data-key="t-dashboards">2 Sub Menu</span>
                                        </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('sub-sub-sub-category.list')); ?>">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">3 Sub Menu</span>
                                        </a>
                                    </li> 
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('news.list')); ?>">
                                <i class="ri-product-hunt-line"></i> <span data-key="t-dashboards">News</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('thankyou-message.list')); ?>">
                                <i class="ri-product-hunt-line"></i> <span data-key="t-dashboards">Thankyou Message</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('category.list')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('transaction.list')); ?>">
                        ...
                        <li class="nav-item">
                            <a href="#usersDetail" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="usersDetail" data-key="t-projects">
                                <i class="ri-question-line"></i>User Details
                            </a>
                            <div class="collapse menu-dropdown" id="usersDetail">
                                <ul class="nav nav-sm flex-column">


                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('user.list')); ?>">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">All Users</span>
                                        </a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="<?php echo e(route('user.list')); ?>">
                                            <i class=" ri-file-copy-line"></i> <span data-key="t-dashboards">User Packages</span>
                                        </a>
                                    </li> 
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('invoice.list')); ?>">
                                <i class="ri-pages-line"></i> <span data-key="t-dashboards">Support</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('package.list')); ?>">
                                <i class="ri-pages-line"></i> <span data-key="t-dashboards">Package</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(route('invoice.list')); ?>">
