...
<?php ($sub_category = DB::table("sub_category")->where("id", Crypt::decryptString(request()->id))->first()); ?>
<?php endif; ?>
...
<script>
   ...
   function get_url_data()
   {
       ...
       data = `status=${status}&order_by=${order_by}&limit=${limit}&filter_search_value=${filter_search_value}&sub_category=${sub_category}`;
   }
    get_url_data();
   url = main_url+'?'+data;
   load_table();
   $(document).on("change", "#statuschange, .order_by, .limit, #sub-category, #category",(function(e) {
      get_url_data();
      url =main_url+"?"+data;
      load_table();
   }));
...
</html><?php /**PATH D:\xamp\htdocs\projects\codediffusion\hindibible\resources\views\admin\sub-sub-category\index.blade.php ENDPATH**/ ?>