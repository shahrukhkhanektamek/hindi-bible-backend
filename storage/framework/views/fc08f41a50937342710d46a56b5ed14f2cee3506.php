                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            <div class="col-lg-6 hide">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Name" name="name" value="<?php echo e(@$row->name); ?>" >
                                            </div>


                                            <div class="col-lg-6">
                                                <label for="formFile" class="form-label">Date</label>
                                                <select class="form-select mb-3" aria-label="Default select example" name="date">
                                                    <option value="">Select</option>
                                                    <?php ($i=1); ?>
                                                    <?php while($i<=31): ?>
                                                        <option value="<?php echo e($i); ?>" <?php if(!empty(@$row) && @$row->date==$i): ?>selected <?php endif; ?> ><?php echo e($i); ?></option>
                                                    <?php ($i++); ?>
                                                    <?php endwhile; ?>
...
</html><?php /**PATH D:\xamp\htdocs\projects\codediffusion\hindibible\resources\views\admin\thankyou-message\form.blade.php ENDPATH**/ ?>