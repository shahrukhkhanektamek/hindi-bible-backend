<?php ($user = DB::table("users")->select('id','name','email','phone','image','user_id','address','city','state')->where("id",$row->user_id)->first()); ?>
                                                        ...
                                                        <tbody id="products-list">
                                                                ...
                                                                <tr>
                                                                    <td class="text-start">
                                                                        ...
                                                                        <?php elseif($row->p_type==2): ?>
                                                                        <p class="text-muted mb-0">Video</p>
                                                                        <?php elseif($row->p_type==3): ?>
                                                                        <p class="text-muted mb-0">Contribution</p>

                                                                        <?php endif; ?>
                                                                    </td>
                                                                    <td>1</td>
                                                                    <td class="text-end"><?php echo e(Helpers::price_formate($row->amount)); ?></td>
                                                                </tr>
                                                ...
                                                <div class="border-top border-top-dashed mt-2">
                                                    <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto" style="width:250px">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>GST </td>
                                                                <td class="text-end"><?php echo e(Helpers::price_formate($row->gst)); ?></td>
                                                            </tr>
                                                            <tr class="border-top border-top-dashed fs-15">
                                                                <th scope="row">Total Amount</th>
                                                                <th class="text-end"><?php echo e(Helpers::price_formate($row->final_amount)); ?></th>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <!--end table-->
...
</html><?php /**PATH C:\xamp\htdocs\projects\hindibible\resources\views/admin/transaction/view.blade.php ENDPATH**/ ?>