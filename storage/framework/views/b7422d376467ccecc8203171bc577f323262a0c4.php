                        ...
                        <div class="col-lg-12">
                            <div class="card" id="applicationList">
                                <div class="card-header  border-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <select class="form-control type" id="typechange">
                                         ...
                                         <div class="col-md-4">
                                            <select class="form-control payment_type" id="payment_typechange">
...
</html><?php /**PATH C:\xamp\htdocs\projects\hindibible\resources\views/admin/transaction/index.blade.php ENDPATH**/ ?>