                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="bank_name" value="<?php echo e(@$form_data->bank_name); ?>" required>
                                            </div>

                                            <div class="col-lg-6">
                                                <label class="form-label" for="product-title-input">Account Holder</label>
                                                <input type="text" class="form-control" placeholder="" name="account_holder" value="<?php echo e(@$form_data->account_holder); ?>" required>
                                            </div>

                                            <div class="col-lg-6">
                                                <label class="form-label" for="product-title-input">Account Number</label>
                                                <input type="text" class="form-control" placeholder="" name="account_number" value="<?php echo e(@$form_data->account_number); ?>" required>
                                            </div>

                                            <div class="col-lg-6">
                                                <label class="form-label" for="product-title-input">IFSC</label>
                                                <input type="text" class="form-control" placeholder="" name="ifsc" value="<?php echo e(@$form_data->ifsc); ?>" required>
                                            </div>

                                            <div class="col-lg-6">
                                                <label class="form-label" for="product-title-input">Branch</label>
                                                <input type="text" class="form-control" placeholder="" name="branch" value="<?php echo e(@$form_data->branch); ?>" required>
                                            </div>

                                            <div class="col-lg-6">
                                                <label class="form-label" for="product-title-input">Swift Code/ BIC Code</label>
                                                <input type="text" class="form-control" placeholder="" name="bic_code" value="<?php echo e(@$form_data->bic_code); ?>" required>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="upi" value="<?php echo e(@$form_data->upi); ?>" required>
                                            </div>
...
</html><?php /**PATH D:\xamp\htdocs\projects\codediffusion\hindibible\resources\views\admin\setting\main-form.blade.php ENDPATH**/ ?>